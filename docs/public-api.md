...
Total public items: **796**

## Modules

- [`runite`](#runite) — 37 items
...
- [`runite::io`](#runiteio) — 193 items
- [`runite::io::compat`](#runiteiocompat) — 25 items
- [`runite::net`](#runitenet) — 101 items
...
- [`runite::sync`](#runitesync) — 38 items
- [`runite::task`](#runitetask) — 24 items
- [`runite::time`](#runitetime) — 13 items
...
pub fn runite::interval<F>(core::time::Duration, F) -> IntervalHandle where F: core::ops::function::FnMut() + 'static
pub fn runite::queue_future<F>(F) -> JoinHandle<<F as core::future::future::Future>::Output> where F: core::future::future::Future + 'static, <F as core::future::future::Future>::Output: 'static
pub fn runite::queue_microtask<F>(F) where F: core::ops::function::FnOnce() + 'static
pub fn runite::queue_task<F>(F) where F: core::ops::function::FnOnce() + 'static
pub fn runite::run()
...
pub fn runite::timeout<F>(core::time::Duration, F) -> TimeoutHandle where F: core::ops::function::FnOnce() + 'static
```
...
impl runite::task::JoinError
pub fn runite::task::JoinError::is_aborted(&self) -> bool
pub fn runite::task::JoinError::is_cancelled(&self) -> bool
impl core::error::Error for runite::task::JoinError
impl core::fmt::Display for runite::task::JoinError
pub fn runite::task::JoinError::fmt(&self, &mut core::fmt::Formatter<'_>) -> core::fmt::Result
...
pub type runite::task::BlockingJoinHandle<R>::Output = core::result::Result<R, runite::task::JoinError>
...
pub async fn runite::time::deadline<F>(core::time::Duration, F) -> core::result::Result<<F as core::future::future::Future>::Output, runite::time::Elapsed> where F: core::future::future::Future
