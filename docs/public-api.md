...
_Generated by `xtask api-report` (`mise run api-report`) with `cargo-public-api`, Rust `nightly-2026-07-01`, and auto-trait, blanket, and derived impls omitted. Do not edit by hand._
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Linux x86_64 (`x86_64-unknown-linux-gnu`) | 1183 | 1203 | 1226 | 1215 | 1286 | 182 |
| Linux aarch64 (`aarch64-unknown-linux-gnu`) | 1183 | 1203 | 1226 | 1215 | 1286 | 182 |
| macOS aarch64 (`aarch64-apple-darwin`) | 1178 | 1198 | 1221 | 1210 | 1281 | 177 |
| Windows x86_64 (`x86_64-pc-windows-msvc`) | 1073 | 1087 | 1116 | 1105 | 1170 | 72 |

Portable default items: **1001**

## Compile-checked handle contract

`cargo-public-api` lists re-exported handle types but currently omits their inherent methods because their definitions live in a private implementation module. `xtask api-report` therefore compiles this contract for every target with default, each individual feature, and all features:
...
pub fn runite::tls::TlsStream<S>::into_parts(self) -> (S, rustls::conn::connection::Connection)
